"""
Defines a custom PyQt6 login window UI with a dark theme.
- Includes fields for username and password, a logo, and a login button.
- Adds a show/hide password button for user convenience.
"""
